...
import * as F from "../../shared/style/Footer";
import * as S from "../../shared/style/Topbar";
    ...
    <div>
      <div className="Tmain">
        <S.Topbar>
          ...
          <div className="login">
            <button className="loginbt" onClick={() => navigate("/login")}>
              로그인
            </button>
            <button className="sinupbt" onClick={() => navigate("/signup")}>
              회원가입
            </button>
          </div>
        </S.Topbar>
        ...
        <div className="Q">
          ...
          <div className="Qcon">
            <div className="qcon">
              ...
              <p className="a">
                네, 기본 기능은 무료로 제공합니다. 더 많은 고급기능을 원하시면
                프리미엄 플랜이 있습니다.
              </p>
            </div>
            <div className="qcon">
